<?php include('monitorloginserver.php') ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('img/hero_1.jpg');">
			...
			<form id="admin-login-form" class="login100-form validate-form" method="POST" action="index.php">
				<?php include('errors.php'); ?>
				
				<?php
						$mysqli = NEW MySQLi ('localhost','root','','E_KANBAN');

						$resultset = $mysqli->query("SELECT username FROM admin_panel_user");
						?>           
			  ...
			  <div>
					<a href="adminlogin.php" class="txt1">

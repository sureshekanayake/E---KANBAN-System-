  ...
  <body>
    <div class="caption">
      <?php
                ...
                $query = "select * from `orders` where module_no = '5';";
  ...
  <div class="limiter">
    ...
    <div class="table100-head">
            ...
            <tr class="row100 head">
              <th class="cell100 column11" style="font-family: Montserrat-Light; font-size: 25px; color:white; font-weight: bold; letter-spacing: 0.5px; width: 80px; padding-left: 20px;"><mark style="background-color: white;">Module Number : <?php echo $row['module_no'] ?></mark><br><mark style="background-color: white;">Shift : <?php echo $row['shift'] ?></mark></th>

              <th class="cell100 column31" style="font-family: Montserrat-Light; font-size: 25px; color:white; font-weight: bold; letter-spacing: 0.5px; width: 80px;"><mark style="background-color: white; margin-top: 2px;">Request By: <?php echo $row['admin_name'] ?> / <?php echo $row['epf_no'] ?></mark></th>

              <th class="cell100 column51" style="font-family: Montserrat-Light; font-size: 25px; color:white; font-weight: bold; letter-spacing: 0.5px; width: 80px;"><mark style="background-color: white;">Complete Time: <?php echo $row['complete_date'] ?></mark></th>

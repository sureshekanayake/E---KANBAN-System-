...
<?php include('requestpanelserver5.php') ?>
...
<br>
 ...
 <form action="requestpanel5.php" method="post">
        <?php include('errors.php'); ?>
    <label style="font-family:Montserrat-Light; font-size:24px; color:white; padding-left: 30px; font-weight: bold; letter-spacing: 0.5px;">Module Number : 6</label>
...
<br>
<div class="footer">
  <button class="btn1234" onclick="window.location.href='../deliver/deliver5.php'"> Show Request Order </button>
</div>

...
<?php include('requestpanelserver8.php') ?>
...
<br>
 ...
 <form action="requestpanel8.php" method="post">
        <?php include('errors.php'); ?>
    <label style="font-family:Montserrat-Light; font-size:24px; color:white; padding-left: 30px; font-weight: bold; letter-spacing: 0.5px;">Module Number : 9</label>
...
<br>
<div class="footer">
  <button class="btn1234" onclick="window.location.href='../deliver/deliver8.php'"> Show Request Order </button>
</div>

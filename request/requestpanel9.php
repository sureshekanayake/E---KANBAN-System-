...
<?php include('requestpanelserver9.php') ?>
...
<br>
 ...
 <form action="requestpanel9.php" method="post">
        <?php include('errors.php'); ?>
    <label style="font-family:Montserrat-Light; font-size:24px; color:white; padding-left: 30px; font-weight: bold; letter-spacing: 0.5px;">Module Number : 10</label>
...
<br>
<div class="footer">
  <button class="btn1234" onclick="window.location.href='../deliver/deliver9.php'"> Show Request Order </button>
</div>

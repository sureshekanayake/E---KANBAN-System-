...
<?php include('requestpanelserver.php') ?>
...
<br>
 ...
 <form action="requestpanel.php" method="post">
    ...
    <label style="font-family:Montserrat-Light; font-size:24px; color:white; padding-left: 30px; font-weight: bold; letter-spacing: 0.5px;">Module Number : 1</label>
...
<br>
<div class="footer">
  <button class="btn1234" onclick="window.location.href='../deliver/deliver.php'"> Show Request Order </button>
</div>

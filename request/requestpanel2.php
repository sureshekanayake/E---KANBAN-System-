...
<?php include('requestpanelserver2.php') ?>
...
<br>
 ...
 <form action="requestpanel2.php" method="post">
        <?php include('errors.php'); ?>
    <label style="font-family:Montserrat-Light; font-size:24px; color:white; padding-left: 30px; font-weight: bold; letter-spacing: 0.5px;">Module Number : 3</label>
...
<div class="footer">
  <button class="btn123" onclick="window.location.href='/androidapppanelhome.php'"> Show Request Order </button>
</div>
<br>
<div class="footer">
  <button class="btn1234" onclick="window.location.href='../deliver/deliver2.php'"> Show Request Order </button>
</div>

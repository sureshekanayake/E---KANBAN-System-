...
<?php include('requestpanelserver1.php') ?>
...
<br>
 ...
 <form action="requestpanel1.php" method="post">
        <?php include('errors.php'); ?>
    <label style="font-family:Montserrat-Light; font-size:24px; color:white; padding-left: 30px; font-weight: bold; letter-spacing: 0.5px;">Module Number : 2</label>
...
<br>
<div class="footer">
  <button class="btn1234" onclick="window.location.href='../deliver/deliver1.php'"> Show Request Order </button>
</div>

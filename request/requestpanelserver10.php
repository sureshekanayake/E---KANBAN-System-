...
if (isset($_POST['submit'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO temporary_orders (admin_name,epf_no,module_no,shift,article_name, quantity,article_name1,quantity1,article_name2,quantity2,article_name3,quantity3,article_name4,quantity4,article_name5,quantity5,article_name6,quantity6,article_name7,quantity7,article_name8,quantity8,article_name9,quantity9,article_name10,quantity10,article_name11,quantity11,article_name12,quantity12,article_name13,quantity13,article_name14,quantity14,article_name15,quantity15,request_date) 
  			  VALUES('$username','$appuser_epf_no','11','$shift','$article_name', '$quantity','$article_name1','$quantity1','$article_name2','$quantity2','$article_name3','$quantity3','$article_name4','$quantity4','$article_name5','$quantity5','$article_name6','$quantity6','$article_name7','$quantity7','$article_name8','$quantity8','$article_name9','$quantity9','$article_name10','$quantity10','$article_name11','$quantity11','$article_name12','$quantity12','$article_name13','$quantity13','$article_name14','$quantity14','$article_name15','$quantity15', CURRENT_TIMESTAMP)";
  	mysqli_query($db, $query);
    header('location: http://192.168.1.10/4/off');
